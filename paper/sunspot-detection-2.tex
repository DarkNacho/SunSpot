...
\begin{figure*}[t]
    \centering
    \subfloat[Imagen Original]{\includegraphics[width=0.30\textwidth]{./image_original.jpg}\label{fig:original}}
    \hfil
    \subfloat[Etiquetas Reales (Ground Truth)]{\includegraphics[width=0.30\textwidth]{./image_label.png}\label{fig:labels}}
    \hfil
    \subfloat[Predicciones del Modelo YOLOv8n]{\includegraphics[width=0.30\textwidth]{./image_predicted.png}\label{fig:predicted}}
